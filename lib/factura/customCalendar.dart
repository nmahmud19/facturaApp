                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: new Border.all(
                        color: FacturaAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: FacturaAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ...
                                  ? FacturaAppTheme.buildLightTheme().primaryColor.withOpacity(0.4)
                                  : Colors.transparent
                                  : Colors.transparent,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date) ? FacturaAppTheme.buildLightTheme().primaryColor : Colors.transparent,
                              borderRadius: BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: DateTime.now().day == date.day && DateTime.now().month == date.month && DateTime.now().year == date.year
                                ? getIsInRange(date) ? Colors.white : FacturaAppTheme.buildLightTheme().primaryColor
                                : Colors.transparent,
