            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: FacturaAppTheme.buildLightTheme().primaryColor,
            ...
            child: Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  CupertinoSwitch(
                    activeColor: date.isSelected ? FacturaAppTheme.buildLightTheme().primaryColor : Colors.grey.withOpacity(0.6),
                    onChanged: (value) {
                      setState(() {
                        checkAppPosition(i);
                      });
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(
                            ...
                            color: date.isSelected ? FacturaAppTheme.buildLightTheme().primaryColor : Colors.grey.withOpacity(0.6),
                          ),
                          SizedBox(
                            width: 4,
                          ),
