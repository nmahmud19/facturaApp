...
import 'package:yt_portfolio2/appTheme.dart';
...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = [
      ...
      DrawerList(
        index: DrawerIndex.Send,
        labelName: 'Отправленные',
        icon: new Icon(Icons.send),
      ),
      DrawerList(
        index: DrawerIndex.Save,
        labelName: 'Сохраненные',
        icon: new Icon(Icons.save),
      ),
      DrawerList(
        index: DrawerIndex.Get,
        labelName: 'Получение',
        icon: new Icon(Icons.get_app),
      ),
      DrawerList(
        index: DrawerIndex.Share,
        labelName: 'Оцените приложение',
          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                   child: Image.asset("assets/drawer_logo.png", width: 200,),
//                  AnimatedBuilder(
...
//                     ),
                  ...
                  listData.isAssetsImage
                    ...
                    child: Image.asset(listData.imageName,
                        color: widget.screenIndex == listData.index
                            ? FacturaAppTheme.buildLightTheme().primaryColor
                ...
                return new Transform(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      height: 46,
                      decoration: BoxDecoration(
                        color: FacturaAppTheme.buildLightTheme().primaryColor.withOpacity(0.2),
                        borderRadius: new BorderRadius.only(
                          topLeft: Radius.circular(0),
